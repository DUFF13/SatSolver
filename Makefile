...
$(EXEC): $(CMO)
	$(OCAMLC) -o $(EXEC) $(LIBS) $(INCLUDES) \
		src/sat_solver.cmo src/quine_dpll.cmo src/dimacs_to_cnf.cmo src/main.cmo
...
src/main.cmo: src/main.ml src/dimacs_to_cnf.cmo src/sat_solver.cmo src/quine_dpll.cmo
	$(OCAMLC) $(INCLUDES) -c $<
